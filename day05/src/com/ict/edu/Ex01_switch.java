...
public class Ex01_switch {
	public static void main(String[] args) {
		/* switch ~ case : 다중 if ~ else 문과 같은 조건문
		 	if 문의 조건식은 boolean, 비교연산, 논리연산 즉 true, false 일때 사용
		 	switch문 int, char, String 일때 사용 (long, float, double 은 사용 불가)
		 	형식) switch (인자값 = int, char, String){
		 			case 조건값1 : 인자값과 조건값1이 같을때 수행할 문장; break;
		 			case 조건값2 : 인자값과 조건값2이 같을때 수행할 문장;
		 						   인자값과 조건값2이 같을때 수행할 문장; break;
		 			case 조건값3 : 인자값과 조건값2이 같을때 수행할 문장; break;
		 			default : 조건식 1,2,3 모두 같지 않을때(나머지) 수행할 문장; break; }
		 			
		 	** 주의사항 : break가 없으면 break 를 만날때까지 모든 수행문을 실행한다.
		 	*	break 의 역할은 실행중인 범위 ({ }블록)를 벗어나는 역할을 한다.
		 	*   default는 생략 가능하다.
		 */
...
//		char k3이 A,a,'1'이면 아프리카, B,b,'2'이면 브라질, C,c,'3'이면 캐나다, 나머지는 한국
		...
		switch (k3) {
			case 'A':
			case 'a': 
			case '1': res= "아프리카"; break;  //case 'A' or case 'a' or case '1'
			case 'B': 
			case 'b': 
...
//		int k5가 3~5:봄,  6~8:여름,  9~11:가을,  12,1,2:겨울 출력하는 코딩
		int k5 = 5;
		switch (k5) {
		case 3: case 4: case 5: res = "봄"; break;
		case 6: case 7: case 8: res = "여름"; break;
		case 9: case 10: case 11: res = "가을"; break;
		case 12: case 1: case 2: res = "겨울"; break;
		}
		System.out.println("결과: "+ res);
		System.out.println("========================");
